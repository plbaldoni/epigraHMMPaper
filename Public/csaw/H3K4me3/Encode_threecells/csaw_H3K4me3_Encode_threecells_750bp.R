...
mark = 'H3K4me3'
bpvec = 750 # Window size
method = 'csaw'
cell = 'Encode_threecells'

chip1 = c(
  'wgEncodeBroadHistoneHelas3H3k4me3StdAlnRep1.markdup.q10.sorted.bam',
  'wgEncodeBroadHistoneHelas3H3k4me3StdAlnRep2.markdup.q10.sorted.bam'
)
chip2 = c(
  'wgEncodeBroadHistoneHepg2H3k4me3StdAlnRep1.markdup.q10.sorted.bam',
  'wgEncodeBroadHistoneHepg2H3k4me3StdAlnRep2.markdup.q10.sorted.bam'
)

chip3 = c(
  'wgEncodeBroadHistoneHuvecH3k4me3StdAlnRep1.markdup.q10.sorted.bam',
