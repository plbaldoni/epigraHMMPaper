...
bin <- 500
condition <- rep(c('helas3', 'hepg2','huvec'), each = 2)
...
rdata <-
  c(
    ...
    'wgEncodeBroadHistoneHuvecH3k27me3StdAlnRep1.markdup.q10.sorted.RData',
    'wgEncodeBroadHistoneHuvecH3k27me3StdAlnRep2.markdup.q10.sorted.RData'
  )
mark <- 'H3K27me3'
method <- 'epigraHMM'
