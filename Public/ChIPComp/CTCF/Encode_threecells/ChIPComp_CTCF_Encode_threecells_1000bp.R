...
chip1 = c('wgEncodeBroadHistoneHelas3CtcfStdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHelas3CtcfStdAlnRep2.markdup.q10.sorted.bam')

chip2 = c('wgEncodeBroadHistoneHepg2CtcfStdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHepg2CtcfStdAlnRep2.markdup.q10.sorted.bam')

chip3 = c('wgEncodeBroadHistoneHuvecCtcfStdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHuvecCtcfStdAlnRep2.markdup.q10.sorted.bam')
