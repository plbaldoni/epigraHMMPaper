...
chip1 = c('wgEncodeBroadHistoneHelas3H3k4me3StdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHelas3H3k4me3StdAlnRep2.markdup.q10.sorted.bam')

chip2 = c('wgEncodeBroadHistoneHepg2H3k4me3StdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHepg2H3k4me3StdAlnRep2.markdup.q10.sorted.bam')

chip3 = c('wgEncodeBroadHistoneHuvecH3k4me3StdAlnRep1.markdup.q10.sorted.bam',
          'wgEncodeBroadHistoneHuvecH3k4me3StdAlnRep2.markdup.q10.sorted.bam')
...
if(mark%in%c('H3K36me3','H3K27me3','EZH2')){
  ...
  dirpeak3 = paste0('../../../MACS2/',mark,'/Huvec/Output/MACS2_',mark,'_Huvec_Output_peaks.broadPeak') 
}
if(mark%in%c('H3K4me3','H3K27ac','CTCF')){
  ...
  dirpeak3 = paste0('../../../MACS2/',mark,'/Huvec/Output/MACS2_',mark,'_Huvec_Output_peaks.narrowPeak') 
}
...
conf <- data.frame(SampleID = 1:6,
                   condition = c('Helas3','Helas3','Hepg2','Hepg2','Huvec','Huvec'),
                   factor = rep(mark,6),
                   ipReads = c(paste0(dirchip1,mark,'/',chip1[1]),paste0(dirchip1,mark,'/',chip1[2]),
                               paste0(dirchip2,mark,'/',chip2[1]),paste0(dirchip2,mark,'/',chip2[2]),
                               paste0(dirchip3,mark,'/',chip3[1]),paste0(dirchip3,mark,'/',chip3[2])),
                   ctReads = c(paste0(dirchip1,'Control','/',control1[1]),paste0(dirchip1,'Control','/',control1[2]),
                               paste0(dirchip2,'Control','/',control2[1]),paste0(dirchip2,'Control','/',control2[2]),
                               paste0(dirchip3,'Control','/',control3[1]),paste0(dirchip3,'Control','/',control3[2])),
