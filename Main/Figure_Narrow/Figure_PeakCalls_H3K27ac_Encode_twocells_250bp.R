...
fig1.h3k27ac = ggplot(data = ChIP[ChIP$Window %in% idx, ], aes(x = start, y =
  ...
  annotate('rect',alpha = 0.1,xmin = 37095129-10*bp,xmax = 37097128+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  geom_segment(
...
save(fig1.h3k27ac, fig2.h3k27ac, fig.h3k27ac, file = 'Figure_PeakCalls_H3K27ac_Encode_twocells_250bp.RData')
