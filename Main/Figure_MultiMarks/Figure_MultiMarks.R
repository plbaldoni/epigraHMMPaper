...
fig.bot <- ggarrange(fig_genesymbols,fig_segmentation[['4']],nrow = 1,legend = 'none',labels = list('E','F'))

# Put them all together

fig.final = ggarrange(fig.top,fig.mid,fig.bot,nrow=3,heights = c(0.275,0.275,0.45))
fig.final.label = ggarrange(fig.final,get_legend(fig_segmentation[['4']]),nrow=2,heights = c(0.95,0.05))
