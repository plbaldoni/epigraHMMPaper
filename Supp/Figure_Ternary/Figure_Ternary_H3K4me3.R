...
load(
  paste0(
    '../../Data/Encode_huvec/',
    mark,
    '/wgEncodeBroadHistoneHuvecH3k4me3StdAlnRep1.markdup.q10.sorted.RData'
  )
)
...
load(
  paste0(
    '../../Data/Encode_huvec/',
    mark,
    '/wgEncodeBroadHistoneHuvecH3k4me3StdAlnRep2.markdup.q10.sorted.RData'
  )
)
...
dt.epigrahmm.h3k4me3 <- dt.epigrahmm.top[!is.na(Pattern),]
setnames(dt.epigrahmm.h3k4me3,c('Peak','Helas3','Hepg2','Huvec','Width','Pattern'))
dt.epigrahmm.h3k4me3$Pattern %<>% plyr::mapvalues(from = 1:6,to = labels)

save(dt.epigrahmm.h3k4me3,file = 'Figure_Ternary_H3K4me3.RData')