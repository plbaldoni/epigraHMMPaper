...
fig1.500 = ggplot(data=ChIP[ChIP$Window%in%idx,],aes(x=start,y=Counts))+
  geom_line()+
...
fig2.500 = ggplot(data=PostProb[PostProb$Window%in%idx,],aes(x=start,y=PP,fill=Component))+facet_grid(rows=vars(Label))+
...
fig.500 = ggarrange(fig1.500,fig2.500,heights = c(0.8,0.2),ncol = 1,nrow = 2,legend = 'none')
save(fig1.500,fig2.500,fig.500,file = 'Figure_PeakCalls_H3K27me3_Encode_twocells_500bp.RData')