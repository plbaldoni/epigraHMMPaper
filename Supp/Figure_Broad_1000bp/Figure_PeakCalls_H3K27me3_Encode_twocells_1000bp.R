...
fig1.h3k27me3 = ggplot(data = ChIP[ChIP$Window %in% idx, ], aes(x = start, y =
                                                                  Counts)) +
  geom_line() +
...
fig2.h3k27me3 = ggplot(data = PostProb[PostProb$Window %in% idx, ], aes(x =
...
save(fig1.h3k27me3, fig2.h3k27me3, fig.h3k27me3, file = 'Figure_PeakCalls_H3K27me3_Encode_twocells_1000bp.RData')
