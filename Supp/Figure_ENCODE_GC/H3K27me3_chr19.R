...
foo_H3K27me3 <- lapply(c(250,500,1000,10000),function(x){
  foo(mark = 'H3K27me3',windowSize = x,chrlist = 'chr19')
})

save(foo_H3K27me3,file = 'H3K27me3_chr19.RData',compress = 'xz')
rm(foo_H3K27me3)
