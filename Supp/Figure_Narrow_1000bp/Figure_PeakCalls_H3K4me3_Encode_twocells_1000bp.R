...
fig1.h3k4me3 = ggplot(data = ChIP[ChIP$Window %in% idx, ], aes(x = start, y =
                                                                  Counts)) +
  geom_line() +
  facet_grid(rows = vars(Group)) +
  annotate('rect',alpha = 0.1,xmin = 7567677-10*bp,xmax = 7568426+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7574676-10*bp,xmax = 7575925+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7582676-10*bp,xmax = 7584924+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7603174-10*bp,xmax = 7604173+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7707415-10*bp,xmax = 7710413+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7728413-10*bp,xmax = 7729412+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  annotate('rect',alpha = 0.1,xmin = 7742911-10*bp,xmax = 7751160+10*bp,ymin = 0,ymax = 1.05*max(dt.segment$Counts,na.rm = T)) +
  geom_segment(
...
fig2.h3k4me3 = ggplot(data = PostProb[PostProb$Window %in% idx, ], aes(x =
...
save(fig1.h3k4me3, fig2.h3k4me3, fig.h3k4me3, file = 'Figure_PeakCalls_H3K4me3_Encode_twocells_1000bp.RData')
